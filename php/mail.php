...
$website = 'YourSite.com'; 	   // Replace Your Domain Name


/* --------------------------------------------
  // Subject
--------------------------------------------- */
$subject = "Message sent via YourSite.com"; // Your Subject
...
if (filter_var($toEmail, FILTER_VALIDATE_EMAIL)) {
	...
	$mail->Body = '<table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
						<tr>
							<td align="center" valign="top">
								<table width="600" bgcolor="#333" valign="top" style="font-size:17px; padding:10px;">
									<tr>
										<td style="text-align:center;" width="100" valign="top"><h1 style="color:#fff;">'.$website.'</h1></td>
									</tr>
								</table>
							</td>
						</tr>
						<tr>
							<td align="center" valign="top">
								<table width="600" bgcolor="#f8f6fe" cellpadding="7" style="font-size:16px; padding:30px; line-height: 28px;">
									...
									<tr>
										<td style="text-align:right; padding-right: 20px;" width="100" valign="top"><strong>Offer:</strong></td>
										<td>' . $_POST['offer'] . '</td>
									</tr>
								</table>
							</td>
